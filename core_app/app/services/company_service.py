...
class CompanyService:
    def __init__(self, db_uri: str, db_name: str):
        ...
        self.company_collection = self.db['CompanyService']
          # Load the taxonomy
        ...
        self.company_collection.create_index("tags")

    def parse_and_store_company_profiles_from_json(self, json_file_path: str, batch_size: int = 1000):
        """
        ...
        try:
            ...
            for i in range(0, total_records, batch_size):
                ...
                if company_profiles:
                    self.company_collection.insert_many(company_profiles)
    ...
    def get_company_profile(self, company_id: str) -> Optional[CompanyProfile]:
        ...
        """
        company_data = self.company_collection.find_one({"_id": company_id})
        if company_data:
